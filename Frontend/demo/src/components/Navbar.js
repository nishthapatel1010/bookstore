        ...
        <div className="navbar bg-base-100">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block border">
              <label className=" flex items-center gap-2 px-3 py-1 rounded-md">
            ...
            <div>
              <a className=" bg-black text-white p-2  border rounded-md hover:bg-slate-800 cursor-pointer" onClick={()=>{
